...
#SBATCH --job-name=2026-03-05_00_add_chr20_plus_changes
...
#SBATCH --time=1-00:00:00  # 0 days, 3 hours, 0 minutes
...
python main.py \
    ...
    --res_dir ./results --name_suffix add_chr_20_plus_changes
